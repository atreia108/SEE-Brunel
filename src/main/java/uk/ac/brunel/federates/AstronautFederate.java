...
public class AstronautFederate extends SEELateJoinerFederate {
    private static final File confFile = new File("src/main/resources/spaceport.conf");

    public AstronautFederate(SEEFederateAmbassador federateAmbassador, FederateConfiguration federateConfiguration) {
    ...
    public static void main(String[] args) {
        ...
        AstronautFederate federate = new AstronautFederate(new SEEFederateAmbassador(), config);
